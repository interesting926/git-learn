/* 这里的代码和压缩包里原版的QR_Encode.h不一样,
是修改过的,更改了纠错等级 好纠错容量
不清楚啥意思 百度一下 学习一下二维码基本知识
*/
...
#define MAX_ALLCODEWORD		113//3706//400// //P14,P35 数据容量[码字]* (E) (VER:40), 所有码字为8位
#define MAX_DATACODEWORD	113//2956//400// //P27     最大信息码子(Ver：40-L)，所有码字为8位
#define MAX_CODEBLOCK		100	//最大纠错码字 Ver：36.37.38_L_第二块
#define MAX_MODULESIZE		37// 21:Version=1,最大字符=17(8.5个汉字)
...
extern unsigned char xdata	 m_byModuleData[MAX_MODULESIZE][MAX_MODULESIZE];
/////////////////////////////////////////////////////////////////////////////
typedef struct 
{
